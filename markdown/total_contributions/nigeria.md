...
The `public contributions` and `private contributions` by users in Nigeria on `2025/12/25 1:08 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
