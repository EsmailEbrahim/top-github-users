...
The `public contributions` and `private contributions` by users in Jordan on `2025/9/28 2:35 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
