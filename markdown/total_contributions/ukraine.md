...
The `public contributions` and `private contributions` by users in Ukraine on `2025/8/21 1:01 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
