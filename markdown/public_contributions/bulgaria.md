...
The `public contributions` by users in Bulgaria on `2025/6/10 2:52 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
