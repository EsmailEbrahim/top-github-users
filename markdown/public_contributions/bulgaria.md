...
The `public contributions` by users in Bulgaria on `2025/9/6 2:19 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
