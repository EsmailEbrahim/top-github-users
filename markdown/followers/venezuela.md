...
The `number of followers` of users in Venezuela on `2025/8/24 1:08 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
