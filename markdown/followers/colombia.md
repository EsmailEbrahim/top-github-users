...
The `number of followers` of users in Colombia on `2025/6/16 2:59 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
