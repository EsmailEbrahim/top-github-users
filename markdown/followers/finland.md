...
The `number of followers` of users in Finland on `2025/9/18 2:22 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
