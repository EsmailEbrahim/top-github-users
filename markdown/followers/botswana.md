...
The `number of followers` of users in Botswana on `2025/6/9 2:58 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
