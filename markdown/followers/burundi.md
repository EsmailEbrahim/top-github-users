...
The `number of followers` of users in Burundi on `2025/6/11 2:47 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
