...
The `number of followers` of users in Nicaragua on `2025/7/25 1:07 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
