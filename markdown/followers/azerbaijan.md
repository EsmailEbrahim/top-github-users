...
The `number of followers` of users in Azerbaijan on `2025/8/31 2:34 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
...
<table>
	...
	<tr>
		...
		<td>No Twitter Username</td>
		<td>Azerbaijan/  telegram : @teymur</td>
		<td>282</td>
	</tr>
	<tr>
		<td>12</td>
